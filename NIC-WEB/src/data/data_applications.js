var dataApplications = [
    ...
    },
    {
        Name: 'IMPORT DN',
        Route: "/Home/LINKDN",
        Image: "/assets/img/img-import.PNG",
        Style: "background-color: rgb(248 225 4); border: 3px solid rgb(186 212 198); box-shadow: 2px 2px 2px #919191;border-radius: 8px; "
    },
];
